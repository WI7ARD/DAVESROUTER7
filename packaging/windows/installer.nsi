...
!define MUI_WELCOMEPAGE_TEXT "This wizard installs ${APP_NAME}, a KiCad board inspector with an AI planning assistant and deterministic autorouting.$\r$\n$\r$\n\
${APP_NAME} never modifies your source files in place: routed results are reviewed and exported to a new file.$\r$\n$\r$\n\
